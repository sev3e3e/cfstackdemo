/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e55371912983326d2583f5ae8983019f)
...
declare namespace NodeJS {
	interface ProcessEnv
		extends StringifyValues<
			Pick<Cloudflare.Env, 'ENVIRONMENT' | 'RELAY_BEARER_TOKEN' | 'AXIOM_API_TOKEN' | 'AXIOM_PROD_DATASET' | 'AXIOM_DEV_DATASET'>
		> {}
}
