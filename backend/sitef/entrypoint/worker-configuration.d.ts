...
/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c2e6fee55cf5c807c1edd440d00f83db)
...
declare namespace Cloudflare {
	interface Env {
		...
		GCP_DEPLOYED_RELAY_ENDPOINT: string;
		CF_DEPLOYED_RELAY_ENDPOINT: string;
		RELAY_BEARER_TOKEN: string;
		AXIOM_API_TOKEN: string;
		AXIOM_LOG_DATASET: string;
		AXIOM_TRACE_DATASET: string;

		DemoScrapingQueue: Queue<DEMO_CommonSiteQueueData>;
...
declare namespace NodeJS {
	interface ProcessEnv
		extends StringifyValues<
			Pick<
				Cloudflare.Env,
				'ENVIRONMENT' | 'RELAY_BEARER_TOKEN' | 'AXIOM_API_TOKEN' | 'AXIOM_PROD_DATASET' | 'AXIOM_DEV_DATASET' | 'DEPLOYED_RELAY_ENDPOINT'
			>
		> {}
}
