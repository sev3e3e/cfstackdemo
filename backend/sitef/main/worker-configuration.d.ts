import type MainD1Handler from '@cfstackdemo/main-d1';
import type MainR2Handler from '@cfstackdemo/main-r2';
import type fetcher from '@cfstackdemo/sitef-fetcher';

import type { Environment } from '@cfstackdemo/types';

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9a4c70e163911aba493c0309793ec53f)
// Runtime types generated with workerd@1.20250712.0 2025-07-11 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ENVIRONMENT: Environment;
		RELAY_BEARER_TOKEN: string;
		DEPLOYED_RELAY_ENDPOINT: string;
		AXIOM_API_TOKEN: string;
		AXIOM_LOG_DATASET: string;
		AXIOM_TRACE_DATASET: string;
		MainD1Worker: Service<MainD1Handler>;
		MainR2Worker: Service<MainR2Handler>;
		SitefFetcher: Service<fetcher>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv
		extends StringifyValues<
			Pick<
				Cloudflare.Env,
				'RELAY_BEARER_TOKEN' | 'AXIOM_API_TOKEN' | 'AXIOM_PROD_DATASET' | 'AXIOM_DEV_DATASET' | 'DEPLOYED_RELAY_ENDPOINT' | 'ENVIRONMENT'
			>
		> {}
}
