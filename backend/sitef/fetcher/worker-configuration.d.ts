import type jwtworker from '@cfstackdemo/jwt-worker';

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a1087fa693107cb53316f27af5166490)
...
declare namespace Cloudflare {
	interface Env {
		...
		ENVIRONMENT: 'development' | 'production' | 'example' | 'test';
		JWTService: Service<jwtworker>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv
		extends StringifyValues<
			Pick<Cloudflare.Env, 'RELAY_BEARER_TOKEN' | 'AXIOM_API_TOKEN' | 'AXIOM_PROD_DATASET' | 'GCP_DEPLOYED_RELAY_ENDPOINT' | 'ENVIRONMENT'>
		> {}
}
