/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9e2caf02d756e03990c78216dc8e4b4d)
// Runtime types generated with workerd@1.20250712.0 2025-08-10
declare namespace Cloudflare {
	interface Env {
		GCP_RELAY_ENDPOINT: string;
		GCP_SERVICE_ACCOUNT_KEY: string;
		GCP_SERVICE_ACCOUNT_EMAIL: string;
		RELAY_BEARER_TOKEN: string;
		ENVIRONMENT: 'development' | 'example' | 'production';
		AXIOM_API_TOKEN: string;
		AXIOM_LOG_DATASET: string;
		AXIOM_TRACE_DATASET: string;
		RelayJWTD1: D1Database;
	}
}
