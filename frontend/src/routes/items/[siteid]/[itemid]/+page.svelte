...
<svelte:head>
	...
	<meta name="description" content={item?.description || 'View detailed information about this item'} />
</svelte:head>
		...
		<Card.Root class="mb-8">
			<Card.Header>
				<div class="flex items-start gap-6">
					<div class="flex-1">
						<Card.Title class="text-2xl font-bold text-gray-900 dark:text-white mb-2">
							{item.title}
						</Card.Title>
						<Card.Description class="text-gray-600 dark:text-gray-400 text-base">
		...
		{#if item.samples && item.samples.length > 0}
			<Card.Root class="mb-8">
				<Card.Header>
					...
					<Card.Description>
						Available samples for this item
					</Card.Description>
				</Card.Header>
				<Card.Content>
					<div class="space-y-3">
	...
	{:else}
		...
		<div class="text-center py-12">
			<div class="space-y-4">
				...
				<h3 class="text-lg font-medium text-gray-900 dark:text-white">Item not found</h3>
